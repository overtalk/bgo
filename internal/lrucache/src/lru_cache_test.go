...
import (
	...
	lru "github.com/overtalk/bgo/internal/lrucache/src"
)

func newLRUCache(cap int64, ttl time.Duration) *lru.CLrucacheModule {
	cache := new(lru.CLrucacheModule)
	cache.Init()
